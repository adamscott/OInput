...
static public class OInput {
	...
	private abstract class OInputAction {
		static protected readonly Dictionary<Axis,string> AxisToString = new Dictionary<Axis, string>(){
		...
		static protected readonly Dictionary<string, Axis> StringToAxis = new Dictionary<string, Axis>() {
		...
		static protected readonly Dictionary<string, KeyCode> StringToKeyCode = new Dictionary<string, KeyCode>() {
